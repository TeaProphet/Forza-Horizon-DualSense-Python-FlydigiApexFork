...
STRINGS = {
    ...
    # --- Flydigi / Rumble ---
    "Telemetry Rumble (Flydigi Apex 4/5)": "Вибрация моторов (Flydigi Apex 4/5)",
    "Speed scale": "Масштаб по скорости",
    "Tire slip scale": "Масштаб по проскальзыванию",
    "Tire slip deadzone": "Мертвая зона проскальзывания",
    "Brake scale": "Масштаб по торможению",
    "Engine RPM scale": "Масштаб по оборотам двигателя",
    "Engine RPM threshold": "Порог оборотов двигателя",
    "Surface/bump scale": "Масштаб по неровностям покрытия",
    "Surface deadzone": "Мертвая зона неровностей",
    "Curb/track strip scale": "Масштаб по поребрикам/виброполосам",
    "Max intensity": "Максимальная интенсивность",
    "Split HID reports (optimized for Flydigi Apex 4)": "Раздельные HID-отчеты (для Flydigi Apex 4)",
    "Rumble motors from telemetry (Flydigi Apex 4/5 / non-Steam rumble)": "Вибрация моторов по телеметрии (Flydigi Apex 4/5)",
    "Misc": "Разное",
    "Test Rumble": "Тест вибрации",
    "Flydigi Emulation": "Эмуляция Flydigi",
    "Auto-activate Flydigi DualSense emulation mode": "Автоактивация эмуляции DualSense для Flydigi",
    "Spawns a background process that signals Flydigi Space Station to switch to DS Mode.": "Запускает фоновый процесс, переключающий Flydigi Space Station в режим DS Mode.",
}
